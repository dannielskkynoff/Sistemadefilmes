...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211012_filmeon_55815e76408acfe03519_20211012222004_archive.zip';
    const ARCHIVE_SIZE       = '65623981';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '55815e7-12222004';
    const SECONDARY_PACKAGE_HASH = '4ad5269-12222004';
    const VERSION            = '4.0.4';
